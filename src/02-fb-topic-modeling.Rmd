...
CHART NOTES:
  1. Red dots indicate weeks where the number of articles exceeds 1.64 SD for that topic
...
saveWidget(
  ...
  selfcontained = FALSE,
  libdir = "../figs/fig_libs"
)

print(chart_topic_trends.wdgt)
...
print(chart_topic_distribution.wdgt)

```

#### Topic Concentration

```{r Data for topic concentration chart}
...
print(chart_topic_concentration.wdgt)

```

### Reactions to News Topics
