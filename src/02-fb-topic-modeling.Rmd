...
posts.wtp %>%
  ...
  mutate(
    relevance = lambda * log(phi_kw) + (1 - lambda) * log(phi_kw/p_w)
  ) ->
  word_relevance.dt

```

We extract the top 30 most relevant words and plot
