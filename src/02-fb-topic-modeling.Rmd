...
We construct a function that will allow us to make these computations in parallel, since this is an embarassingly parallel problem.
...
crossValidatePerplexity(
  dtm          = posts_tokenized.dtm[sample(1:posts_tokenized.dtm$nrow, posts_tokenized.dtm$nrow * 0.1),],
  n_folds      = 5,
...
pushNotification("Cross validation complete!")
